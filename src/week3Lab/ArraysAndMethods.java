...
//print out the first element in the array
		...
		//write a traditional loop that prints out each element in the array
		...
		//calculate the sum of the letters in the new array
		int sumOfLetters = 0;
		...
		//write and test a method that takes and array of double and returns the average
		...
		//even amount of letters is greater than the sum of those with an off amount of letters.
